...
class Activity(Base):
    ...
    activity_mode = Column(String(20), nullable=False, default="normal")
    debate_pro_label = Column(String(255), nullable=True)
    debate_con_label = Column(String(255), nullable=True)
